...
const Register = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat p-4 py-12"
      ...
      <motion.div
        ...
        <button
          ...
          className="w-full py-4.5 bg-indigo-600 text-white rounded-2xl size18 degular-semibold hover:bg-indigo-700 shadow-lg shadow-indigo-500/20 active:scale-[0.98] transition-all">
