...
const StatCard = ({icon: Icon, label, value, color, delay}) => (
  <motion.div
    ...
    <div
      className={`w-14 h-14 rounded-2xl flex items-center justify-center ${color} text-white shadow-lg`}>
      <Icon size={24} />
    </div>
    <div>
      <p className="size14 degular-semibold text-slate-400 uppercase tracking-wider">
        {label}
      </p>
      <h3 className="size24 degular-semibold text-slate-800">{value}</h3>
    </div>
  </motion.div>
);
                      ...
                      <motion.tr
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-4">
                            <div className="shrink-0 w-12 h-12 rounded-xl bg-slate-100 overflow-hidden border border-slate-200 shadow-sm">
                              {product.image && (
                                <img
                            ...
                            <span className="size14 degular-semibold text-slate-800">
                              {product.name}
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1.5 min-w-[120px]">
                            <div className="flex justify-between items-center mb-1">
                              <span
                                className={`size10 degular-semibold px-2 py-0.5 rounded-full uppercase tracking-wider ${
                                  product.stock === 0
                  ...
                  <motion.div
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="size14 degular-semibold text-slate-800 truncate max-w-[120px]">
                            {order.user?.shopName || "Unregistered Shop"}
                          </p>
                          <p className="size12 text-slate-400">
                            #{order._id.slice(-6).toUpperCase()}
                          </p>
                        </div>
                      </div>
                      <p className="size14 degular-semibold text-indigo-600">
                        ₹{order.totalAmount}
                      </p>
                    </div>

                    <div className="flex items-center justify-between gap-4 mt-2">
                      <span className="size11 degular-semibold text-slate-400 uppercase tracking-wider">
                      ...
                      <div className="relative status-dropdown-container">
                        <button
                          ...
                          className={`flex items-center gap-2 px-3 py-1.5 rounded-lg size12 degular-semibold transition-all border ${
                            ...
                            <motion.div
                              ...
                              {[
                                ...
                                <button
                                  ...
                                  className={`cursor-pointer w-full text-left px-4 py-2 size12 degular-semibold transition-colors ${
